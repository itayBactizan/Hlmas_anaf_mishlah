...
import logging
from .components_xgb import BatchFlattener
...
class DualMCModelOrchestrator:
    ...
    def _execute_pipeline_step(self, df_chunk: pd.DataFrame) -> pd.DataFrame:
        ...
        enriched_queries, enriched_cands = self.context_enricher.enrich(queries, trunc_codes, trunc_labels, raw_scores, row_ids)
